...
- Ender Dragon sound cues (roar/growl/flap) now produce directional, distance-scaled haptics so the rumble shifts around you as the dragon moves (and are capped to never exceed damage haptics).
