...
public final class SchemaSoundscapeOverrideEditScreen extends Screen {
    private final SchemaSoundscapeOverridesScreen parent;
    private final Map<String, String> overrides;
    private final String originalKey;

    private EditBox keyBox;

    private NeonButton targetButton;
    private List<String> targetOptions;
    private int targetIndex;

    public SchemaSoundscapeOverrideEditScreen(SchemaSoundscapeOverridesScreen parent, Map<String, String> overrides, String originalKey) {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new StringWidget(
                ...
                280,
                20,
                Component.translatable("bassshakertelemetry.soundscape.override_edit_title"),
                font
        ));
        ...
        this.addRenderableWidget(new StringWidget(
                ...
                contentWidth,
                14,
                Component.translatable("bassshakertelemetry.soundscape.override_key"),
                font
        ));
        ...
        this.addRenderableWidget(new StringWidget(
                ...
                contentWidth,
                14,
                Component.translatable("bassshakertelemetry.soundscape.override_target"),
                font
        ));
        ...
        targetButton = new NeonButton(
                ...
                contentWidth,
                20,
                targetLabel(targetOptions.get(targetIndex)),
                () -> {
