...
public final class GameSoundDeviceScreen extends Screen {
    ...
    public GameSoundDeviceScreen(Screen parent, Consumer<String> onSelectDevice) {
        this(parent, onSelectDevice, null);
    }

    public GameSoundDeviceScreen(Screen parent, Consumer<String> onSelectDevice, String initialSelectedDevice) {
        super(Component.translatable("bassshakertelemetry.config.game_sound_device_title"));
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new StringWidget(
                ...
                280,
                20,
                Component.translatable("bassshakertelemetry.config.game_sound_device_title"),
                font
        ));

        List<String> deviceNames = new ArrayList<>();
        deviceNames.add("<Default>");
        deviceNames.addAll(MinecraftSoundDeviceUtil.listAvailableOutputDevices());
    ...
    private void onDone() {
        // Apply selection back to the parent; actual application happens when the user hits Done on the main config screen.
    ...
    private final class DeviceEntry extends ContainerObjectSelectionList.Entry<DeviceEntry> {
        ...
        public void render(GuiGraphics guiGraphics, int index, int y, int x, int rowWidth, int rowHeight,
            ...
            guiGraphics.drawString(Objects.requireNonNull(GameSoundDeviceScreen.this.font), Objects.requireNonNull(deviceId), x + 4, y + 5, color);
        }
